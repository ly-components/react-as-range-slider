...
/***/ function(module, exports, __webpack_require__) {
	...
	_react2['default'].render(_react2['default'].createElement(_srcIndex.NumberSlider, { onChange: function (val) {
	    return document.querySelector('#normal-result').textContent = val;
	...
	_react2['default'].render(_react2['default'].createElement(_srcIndex.NumberSlider, { max: 200, min: 100, onChange: function (val) {
	    return document.querySelector('#normal-limit-result').textContent = val;
	  } }), document.querySelector('#normal-limit'));

	_react2['default'].render(_react2['default'].createElement(_srcIndex.NumberSlider, { max: 200, min: 100, onChange: function (val) {
	    return document.querySelector('#normal-step-result').textContent = val;
	  }, step: 10 }), document.querySelector('#normal-step'));

	_react2['default'].render(_react2['default'].createElement(_srcIndex.NumberSlider, { max: 200, min: 100, onChange: function (val) {
	    return document.querySelector('#normal-width-result').textContent = val;
	  }, step: 10, width: 600 }), document.querySelector('#normal-width'));
	...
	_react2['default'].render(_react2['default'].createElement(_srcIndex.RangeSlider, { max: 200, min: 100, onChange: function (val) {
	    return document.querySelector('#range-limit-result').textContent = '' + val[0] + ', ' + val[1];
	  } }), document.querySelector('#range-limit'));

	_react2['default'].render(_react2['default'].createElement(_srcIndex.RangeSlider, { max: 200, min: 100, onChange: function (val) {
	    return document.querySelector('#range-step-result').textContent = '' + val[0] + ', ' + val[1];
	  }, step: 10 }), document.querySelector('#range-step'));
	...
	_react2['default'].render(_react2['default'].createElement(
	  ...
	  _react2['default'].createElement(
	    ...
	    null,
	    'Number Slider: ',
	    _react2['default'].createElement(_srcIndex.NumberSlider, { name: 'number', min: 100, max: 200, value: 150 })
	  ),
	  _react2['default'].createElement(
	    'p',
	    null,
	    'Range Slider: ',
	    _react2['default'].createElement(_srcIndex.RangeSlider, { name: 'range', min: 100, max: 200, value: [120, 180] })
	  ),
	  _react2['default'].createElement(
	    'p',
	    null,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _libNumberSlider = __webpack_require__(226);

	var _libNumberSlider2 = _interopRequireDefault(_libNumberSlider);

	var _libRangeSlider = __webpack_require__(239);

	var _libRangeSlider2 = _interopRequireDefault(_libRangeSlider);

	__webpack_require__(240);

	exports['default'] = {
	  NumberSlider: _libNumberSlider2['default'],
	  RangeSlider: _libRangeSlider2['default']
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactAsDnd = __webpack_require__(234);

	var _reactAsDnd2 = _interopRequireDefault(_reactAsDnd);

	var _util = __webpack_require__(238);

	var NumberSlider = (function (_React$Component) {
	  function NumberSlider(props) {
	    _classCallCheck(this, NumberSlider);
	  ...
	  _inherits(NumberSlider, _React$Component);
	  ...
	  _createClass(NumberSlider, [{
	    ...
	    value: function _handleDragMove(e) {
	      ...
	      var value = (0, _util.getValueByOffset)(e.dragShowX, width, max, min, step);
	    ...
	    value: function render() {
	      ...
	      var offset = (0, _util.getOffsetByValue)(this.state.value, width, max, min, step);
	      var config = {
	        start: {
	          x: offset,
	          y: 4
	        ...
	        grid: {
	          x: (0, _util.getPixPerStep)(width, max, min, step),
	          y: 0
	        },
	        axis: 'x',
	        limit: {
	      ...
	      return _react2['default'].createElement(
	        'div',
	        { className: this.props.className, style: { width: this.props.width } },
	        this.props.name && _react2['default'].createElement('input', { name: this.props.name, type: 'hidden', value: this.state.value }),
	        _react2['default'].createElement(
	          'div',
	          { className: 'react-as-range-slider-line' },
	          _react2['default'].createElement('div', { className: 'react-as-range-slider-line-range', style: { width: offset } })
	        ),
	        _react2['default'].createElement(
	          _reactAsDnd2['default'],
	          _extends({ axis: 'x', limit: 'parent', shadow: false }, config),
	          _react2['default'].createElement('span', { className: 'react-as-range-slider-btn' })
	        )
	      );
	    }
	  }], [{
	...
	(0, _reactMixin2['default'])(NumberSlider.prototype, _reactAsEventMixin2['default']);

	exports['default'] = NumberSlider;
	module.exports = exports['default'];

	/* REACT HOT LOADER */ }).call(this); if (true) { (function () { module.hot.dispose(function (data) { data.makeHot = module.makeHot; }); if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(229), foundReactClasses = false; if (makeExportsHot(module, __webpack_require__(59))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "NumberSlider.jsx" + ": " + err.message); } }); } } })(); }
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(34)(module)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _libComponent = __webpack_require__(235);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _domHelper = __webpack_require__(236);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* REACT HOT LOADER */ }).call(this); if (true) { (function () { module.hot.dispose(function (data) { data.makeHot = module.makeHot; }); if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(229), foundReactClasses = false; if (makeExportsHot(module, __webpack_require__(59))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "domHelper.jsx" + ": " + err.message); } }); } } })(); }
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(34)(module)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	function getPixPerStep(width, max, min, step) {
	  var pixPerStep = width / getTotalSteps(max, min, step);
	  return pixPerStep;
	}

	function getOffsetByValue(value, width, max, min, step) {
	  var curStep = Math.round((value - min) / (max - min) * getTotalSteps(max, min, step));
	  var pixPerStep = getPixPerStep(width, max, min, step);
	  return curStep * pixPerStep;
	}

	function getValueByOffset(offset, width, max, min, step) {
	  var pixPerStep = getPixPerStep(width, max, min, step);
	  var steps = Math.round(offset / pixPerStep);
	  var value = steps * step + min;
	  return value > max ? value - step : value;
	}

	function getSteppedValue(value, max, min, step) {
	  if ((value - min) % step !== 0) value = Math.floor((value - min) / step) * step;
	  return value;
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NumberSlider = (function (_React$Component) {
	  ...
	  _createClass(NumberSlider, [{
	    ...
	    key: '_handleLeftDragMove',
	    value: function _handleLeftDragMove(e) {
	      var _props = this.props;
	      var width = _props.width;
	      var max = _props.max;
	      var min = _props.min;
	      ...
	      var left = (0, _util.getValueByOffset)(e.dragShowX, width, max, min, step);
	    ...
	    key: '_handleRightDragMove',
	    value: function _handleRightDragMove(e) {
	      var _props2 = this.props;
	      var width = _props2.width;
	      var max = _props2.max;
	      var min = _props2.min;
	      ...
	      var right = (0, _util.getValueByOffset)(e.dragShowX, width, max, min, step);
	    ...
	    value: function render() {
	      ...
	      var leftOffset = (0, _util.getOffsetByValue)(left, width, max, min, step);
	      var rightOffset = (0, _util.getOffsetByValue)(right, width, max, min, step);
	      var leftDraggable = left !== min;
	      var rightDraggable = right !== (0, _util.getSteppedValue)(right, max, min, step);
	      var pixPerStep = (0, _util.getPixPerStep)(width, max, min, step);
	      var commonDragConfig = {
	        axis: 'x',
	        shadow: false,
	        grid: {
	          x: pixPerStep,
	      ...
	      var leftDragConfig = (0, _util.merge)({}, commonDragConfig, {
	        start: {
	          x: leftOffset,
	          y: 4
	        },
	      ...
	      var rightDragConfig = (0, _util.merge)({}, commonDragConfig, {
	        start: {
	          x: rightOffset,
	          y: 4
	        },
	      ...
	      return _react2['default'].createElement(
	        'div',
	        { className: this.props.className, style: { width: this.props.width } },
	        this.props.name && _react2['default'].createElement('input', { name: this.props.name, type: 'hidden', value: [left, right] }),
	        _react2['default'].createElement(
	          'div',
	          { className: 'react-as-range-slider-line' },
	          _react2['default'].createElement('div', { className: 'react-as-range-slider-line-range', style: { width: rightOffset - leftOffset, marginLeft: leftOffset } })
	        ),
	        _react2['default'].createElement(
	          _reactAsDnd2['default'],
	          leftDragConfig,
	...
	/* REACT HOT LOADER */ }).call(this); if (true) { (function () { module.hot.dispose(function (data) { data.makeHot = module.makeHot; }); if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(229), foundReactClasses = false; if (makeExportsHot(module, __webpack_require__(59))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "RangeSlider.jsx" + ": " + err.message); } }); } } })(); }
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(34)(module)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.push([module.id, ".react-as-range-slider {\n  position: relative;\n  display: inline-block;\n  height: 24px;\n  padding: 0 8px;\n  -webkit-user-select: none;\n  -moz-user-select: none;\n  -o-user-select: none;\n  -ms-user-select: none;\n      user-select: none;\n}\n.react-as-range-slider .react-as-range-slider-line {\n  background-color: #ddd;\n  position: absolute;\n  height: 2px;\n  border-radius: 1px;\n  left: 8px;\n  right: 8px;\n  top: 50%;\n  margin-top: -1px;\n  overflow: hidden;\n}\n.react-as-range-slider .react-as-range-slider-line .react-as-range-slider-line-range {\n  background-color: #16a085;\n  height: 100%;\n}\n.react-as-range-slider .react-as-range-slider-btn {\n  position: relative;\n  display: block;\n  background-color: #16a085;\n  width: 16px;\n  height: 16px;\n  border-radius: 50%;\n}\n", ""]);
